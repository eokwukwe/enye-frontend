    ...
    <>
      <div className='pb-10'>
                    ...
                    {headerGroups.map(headerGroup => (
                      <tr {...headerGroup.getHeaderGroupProps()}>
                        {headerGroup.headers.map(column => (
                          <th
                            scope='col'
                            className='px-6 py-1 align-top text-left text-xs font-bold text-gray-600 uppercase tracking-wider'
        ...
        <div className='flex mt-3 justify-end'>
          <div>
            <span>Page</span>{' '}
            <span className='text-gray-700 font-bold'>{pageIndex + 1}</span> of{' '}
